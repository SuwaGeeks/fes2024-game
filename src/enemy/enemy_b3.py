...
from ..bullet.bullet_e3 import bullet as BulletE3
from ..bullet.bullet import bullet as BulletBase
from config import Config as CFG

class EnemyB3(EnemyBase):
    ...
    def update(
        ...
        if self.shot_cycle == 0:
            ...
            enemy_bullets.append(BulletE3(self.rect.center[0] + 5, self.rect.bottom, 0, 10))
            enemy_bullets.append(BulletE3(self.rect.center[0] + 5 + 5, self.rect.bottom, 0, 5))
